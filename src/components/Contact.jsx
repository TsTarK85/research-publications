        ...
        <div className="contact-container">
          <div className="contact-info">
            ...
            <div className="info-item">
              ...
              Rais Towers, 2nd Floor, Chennai, India.
            </div>
            <div className="info-item">
              <strong>Phone:</strong>
              +91 91507 70317 <br/> +91 93455 34648
            </div>
            <div className="info-item">
              <strong>Email:</strong>
              info@researchpublications.com
            </div>

            {/* Social Icons Moved Here */}
            <div className="contact-socials" style={{marginTop: '24px'}}>
              <h4 style={{marginBottom: '10px', color:'#fff', fontSize:'1rem'}}>Join Our Community</h4>
          ...
          <form className="contact-form" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="hero-btn" style={{border:'none', cursor:'pointer', width:'100%'}}>
              Send Message
            </button>
          </form>
        </div>
